...
// const fortune = 'You will be a ' + jobTitle + ' in ' + geoLocation + ', and married to ' + partnersName + ' with ' + numberOfChildren + ' children.';
...
let celsiusTemp = 47;
let farhenheitTemp = (celsiusTemp * 1.8) + 32;
console.log(`${celsiusTemp}˚C is ${farhenheitTemp.toFixed(2)}˚F.`);
